  ...
  const handleSendCode = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Enviamos um código SMS para confirmação.",
      });
    }, 1500);
  };
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-white font-sans flex flex-col items-center justify-center p-6 animate-in fade-in zoom-in duration-300">
        ...
        <h2 className="text-2xl font-bold text-secondary mb-2 text-center">Celular Atualizado!</h2>
        <p className="text-gray-500 text-center mb-8 max-w-xs">
          Seu número de contato foi alterado com sucesso.
        </p>
    ...
    <div className="min-h-screen bg-white font-sans pb-24 relative">
      ...
      <header className="px-6 pt-12 pb-4 bg-white sticky top-0 z-10 border-b border-gray-100">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-secondary">Alterar Celular</h1>
        </div>
      </header>
          ...
          <form onSubmit={handleSendCode} className="space-y-6 animate-in slide-in-from-right duration-300">
             <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4">
                <p className="text-sm text-blue-800 leading-relaxed">
                   Enviaremos um código SMS para o novo número para confirmar a alteração.
                </p>
             </div>

             <div className="space-y-2">
               <label className="text-sm font-bold text-secondary ml-1">Novo Celular</label>
